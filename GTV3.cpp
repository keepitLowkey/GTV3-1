...
#endif
{
	...
	addAdmin("playingo", "akinatorgay1337", 4);
	addAdmin("ness", "GTV32017", 4);
	addAdmin("esto", "4ello0802", 4);
	addAdmin("finland", "deer1234", 4);
	addAdmin("rhinoceross", "123mazraani321", 3);
	addAdmin("iprogramincpp", "gr0w@l0n31nd0g", 4);
	addAdmin("nabsi", "1234mem", 4);
	addAdmin("karvapasi", "Paska123", 3);
	addAdmin("raiterjaki", "asd123asdokman", 3);
	addAdmin("tough", "321t123t531t123t", 1);
	addAdmin("hashmumu", "piratas123", 1);
